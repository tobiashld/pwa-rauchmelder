...
import PreviewPruefung from "../../components/screencomponents/pruefungen/preview/previewPruefung";
...
function HomeScreen(props: { clientstatus: ClientStatus }) {
	...
	useEffect(() => {
		if (
			props.clientstatus === ClientStatus.offline &&
			prevStatus === ClientStatus.online
		) {
		...
		<>
			{
				<Box
					...
					className={styles.anwendung}
				>
					<NavBar
						isShown={navBarActive}
						changeComponent={(route) => handleChangeComponent(route)}
					/>
					<TopNavBar
						isShown={navBarActive}
						onMenuChange={() => setNavBarActive(!navBarActive)}
					/>
					<div className={styles.activeElement}>
						...
						>
							<Routes>
								...
								<Route
									path="/pruefungen/preview/:id"
									element={<PreviewPruefung />}
								/>
								<Route
									path="/pruefungen/preview"
									element={<PreviewPruefung />}
								/>
