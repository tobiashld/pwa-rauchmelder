...
const ChangeWohnungenDialog = (props: {
	isShown: boolean;
	handleClose: (toCreateWohnung?: Wohnung) => void;
	triggerNewEntity: (toCreateWohnung: Wohnung) => void;
	...
	return (
		<StyledDialog
			props={{
				title: {
					id: "change-Wohnung-dialog",
					onClose: () => props.handleClose(),
					children: props.currentWohnung?.nachname ?? "Wohnung hinzufügen",
				},
				general: {
					open: props.isShown,
					fullWidth: true,
...
export default ChangeWohnungenDialog;
