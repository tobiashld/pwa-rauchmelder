...
function AddAuftraggeber() {
	...
	const [auftraggeber, setAuftraggeber] = useState<Auftraggeber[]>([
		new Auftraggeber(0, new Adresse(0, "", "", ""), "", "", ""),
	]);
	...
	const handleSave = () => {
		auftraggeber.forEach((auftraggeber) => {
			dataFunctions[clientStatus].auftraggeber.create(
				auftraggeber,
				(data) => {}
			);
		});
	...
	const handleAdd = () => {
		let newAuftraggeber = new Auftraggeber(
			auftraggeber.length,
			new Adresse(0, "", "", ""),
			"",
			"",
		...
		<div className={styles.gesamtContainer}>
			...
			<div className={styles.actualTable}>
				<div className={styles.columns}>
					...
					<div className={styles.columnsegment + " " + styles.id}>
						Hausnummer
					</div>
